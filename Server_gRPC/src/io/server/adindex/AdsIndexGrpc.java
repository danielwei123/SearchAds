...
public final class AdsIndexGrpc {
  ...
  public static final io.grpc.MethodDescriptor<io.server.adindex.AdsRequest,
      io.server.adindex.AdsReply> METHOD_GET_ADS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "adindex.AdsIndex", "GetAds"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.server.adindex.AdsRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(io.server.adindex.AdsReply.getDefaultInstance()));
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.server.adindex.AdsRequest,
                io.server.adindex.AdsReply>(
  ...
  public static final class AdsIndexBlockingStub extends io.grpc.stub.AbstractStub<AdsIndexBlockingStub> {
     ...
     * </pre>
     */
    public io.server.adindex.AdsReply getAds(io.server.adindex.AdsRequest request) {
  ...
  public static final class AdsIndexFutureStub extends io.grpc.stub.AbstractStub<AdsIndexFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.server.adindex.AdsReply> getAds(
        io.server.adindex.AdsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ADS:
          serviceImpl.getAds((io.server.adindex.AdsRequest) request,
              (io.grpc.stub.StreamObserver<io.server.adindex.AdsReply>) responseObserver);
          break;
        default:
  ...
  private static final class AdsIndexDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.server.adindex.SearchAds.getDescriptor();
    }
  }
