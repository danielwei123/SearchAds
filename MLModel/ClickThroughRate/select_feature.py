...
if __name__ == "__main__":
    ...
    output_dir = "project/SearchAds/data/log/"
    ...
    device_id_click.saveAsTextFile(output_dir + "_device_id_click")
    device_id_impression.saveAsTextFile(output_dir + "_device_id_impression")

    device_ip_click.saveAsTextFile(output_dir + "_device_ip_click")
    device_ip_impression.saveAsTextFile(output_dir + "_device_ip_impression")

    ad_id_click.saveAsTextFile(output_dir + "_ad_id_click")
    ad_id_impression.saveAsTextFile(output_dir + "_ad_id_impression")

    query_campaign_id_click.saveAsTextFile(output_dir + "_query_campaign_id_click")
    query_campaign_id_impression.saveAsTextFile(output_dir + "_query_campaign_id_impression")

    query_ad_id_click.saveAsTextFile(output_dir + "_query_ad_id_click")
    query_ad_id_impression.saveAsTextFile(output_dir +"_query_ad_id_impression")
    sc.stop()
